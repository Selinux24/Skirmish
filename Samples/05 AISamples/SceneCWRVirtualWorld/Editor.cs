...
namespace AISamples.SceneCWRVirtualWorld
{
    class Editor(Graph graph)
    {
        ...
        public void UpdateInputEditor(IGameTime gameTime, float threshold)
        {
        ...
        public void DrawGraph(float height, float pointStroke, float lineStroke)
        {
