...
namespace Collada
{
    static class UIControlExtensions
    {
        ...
        public static void Show(this UIControlTweener tweener, IUIControl ctrl, long milliseconds, float delay)
        {
            tweener.TweenAlpha(ctrl, -delay * milliseconds, 1, milliseconds, ScaleFuncs.Linear);
        }
        ...
        public static void Hide(this UIControlTweener tweener, IUIControl ctrl, long milliseconds, float delay)
        {
            tweener.TweenAlpha(ctrl, delay * milliseconds, 0, milliseconds, ScaleFuncs.Linear);
        }
