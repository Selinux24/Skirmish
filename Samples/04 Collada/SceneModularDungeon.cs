...
namespace Collada
{
    public class SceneModularDungeon : Scene
    {
        ...
        private async Task InitializeUI()
        {
            ...
            this.info = await this.AddComponentUITextArea(new UITextAreaDescription { Font = TextDrawerDescription.Generate("Lucida Sans", 12, Color.Yellow) }, layerHUD);
            this.info.Text = null;
            ...
            this.messages = await this.AddComponentUITextArea(new UITextAreaDescription { Font = TextDrawerDescription.Generate("Lucida Sans", 48, Color.Red, Color.DarkRed) }, layerHUD);
