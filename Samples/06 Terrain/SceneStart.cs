...
namespace Terrain
{
    class SceneStart : Scene
    {
        ...
        private async Task InitializeAssets()
        {
            ...
            var startButtonDesc = UIButtonDescription.DefaultTwoStateButton("SceneStart/buttons.png", new Vector4(55, 171, 545, 270) / 600f, new Vector4(55, 171, 545, 270) / 600f, buttonsFont);
            ...
            var exitButtonDesc = UIButtonDescription.DefaultTwoStateButton("SceneStart/buttons.png", new Vector4(55, 171, 545, 270) / 600f, new Vector4(55, 171, 545, 270) / 600f, buttonsFont);
