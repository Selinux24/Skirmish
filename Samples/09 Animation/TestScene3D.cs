...
namespace Animation
{
    public class TestScene3D : Scene
    {
        ...
        private async Task InitializeUI()
        {
            ...
            this.runtime = await this.AddComponentUITextArea(new UITextAreaDescription { Font = TextDrawerDescription.Default("Tahoma", 11, Color.Yellow) }, layerHUD);
            this.animText = await this.AddComponentUITextArea(new UITextAreaDescription { Font = TextDrawerDescription.Default("Tahoma", 15, Color.Orange) }, layerHUD);
            this.messages = await this.AddComponentUITextArea(new UITextAreaDescription { Font = TextDrawerDescription.Default("Tahoma", 15, Color.Orange) }, layerHUD);
