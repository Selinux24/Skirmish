...
namespace Deferred
{
    public class TestScene3D : Scene
    {
        ...
        {
            var dTitle = new UITextAreaDescription { Font = TextDrawerDescription.Default("Tahoma", 18, Color.White) };
            var dLoad = new UITextAreaDescription { Font = TextDrawerDescription.Default("Lucida Sans", 12, Color.Yellow) };
            var dHelp = new UITextAreaDescription { Font = TextDrawerDescription.Default("Lucida Sans", 12, Color.Yellow) };
            var dStats = new UITextAreaDescription { Font = TextDrawerDescription.Default("Lucida Sans", 10, Color.Red) };
