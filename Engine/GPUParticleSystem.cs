...
namespace Engine
{
    ...
    /// Particle system
    /// </summary>
    public class GPUParticleSystem : Drawable
    {
        /// <summary>
        /// Emitter list
        /// </summary>
        private List<GPUParticleEmitter> emitters = new List<GPUParticleEmitter>();
        /// <summary>
        /// Random texture
        /// </summary>
        ...
        public GPUParticleSystem(Game game, GPUParticleSystemDescription description)
            : base(game, description)
        {
            foreach (var emitterDesc in description.Emitters)
            {
                var emitter = new GPUParticleEmitter(game, emitterDesc);
            ...
            if (effect != null)
            {
                ...
                foreach (var emitter in this.emitters)
                {
...

                    {
                        ...
                        var technique = effect.GetTechniqueForDrawing(VertexTypes.GPUParticle, context.DrawerMode);
        ...
        public GPUParticleEmitter Add(GPUParticleEmitterDescription desc)
        {
            var emitter = new GPUParticleEmitter(this.Game, desc);
