...
namespace Engine
{
    ...
    /// Particle emitter
    /// </summary>
    public class GPUParticleEmitter : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public GPUParticleEmitterDescription Description;
        /// <summary>
        /// Total game time
        /// </summary>
        ...
        public GPUParticleEmitter(Game game, GPUParticleEmitterDescription emitter)
        {
            ...
            this.drawingBuffer = game.Graphics.Device.CreateBuffer<VertexGPUParticle>(emitter.ParticleCountMax, ResourceUsage.Default, BindFlags.VertexBuffer | BindFlags.StreamOutput, CpuAccessFlags.None);
            this.streamOutBuffer = game.Graphics.Device.CreateBuffer<VertexGPUParticle>(emitter.ParticleCountMax, ResourceUsage.Default, BindFlags.VertexBuffer | BindFlags.StreamOutput, CpuAccessFlags.None);
