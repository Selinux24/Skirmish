...
namespace Engine.Common
{
    ...
    /// </summary>
    public struct EngineStreamOutputElement
    {
        ...
        /// Constructor
        /// </summary>
        public EngineStreamOutputElement(string semanticName, int semanticIndex, byte startComponent, byte componentCount, byte outputSlot)
        {
            Stream = 0;
