...
{
    /// <summary>
    /// Remove instancing buffer descriptor request
    /// </summary>
    class BufferDescriptorRemoveInstancingRequest(BufferDescriptor descriptor) : IBufferDescriptorRequest
    {
        /// <summary>
        ...
        public void Process(BufferManager bufferManager)
        {
            ...
            {
                var desc = bufferManager.GetInstancingBufferDescription(descriptor.BufferDescriptionIndex);
