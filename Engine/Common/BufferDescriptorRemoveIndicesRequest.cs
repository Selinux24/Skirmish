...
{
    /// <summary>
    /// Remove index buffer descriptor request
    /// </summary>
    class BufferDescriptorRemoveIndicesRequest(BufferDescriptor descriptor) : IBufferDescriptorRequest
    {
        /// <summary>
        ...
        public void Process(BufferManager bufferManager)
        {
            ...
            {
                var desc = bufferManager.GetIndexBufferDescription(descriptor.BufferDescriptionIndex);
