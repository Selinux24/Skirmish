...
namespace Engine
{
    ...
    public class VolumeInstanced : ModelBase
    {
        ...
        public VolumeInstanced(Game game, Scene3D scene, ModelContent model, int instances)
            : this(game, scene, model, instances, false)
        {

        }
        public VolumeInstanced(Game game, Scene3D scene, ModelContent model, int instances, bool randomTimePos)
