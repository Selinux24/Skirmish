...
namespace Engine.BuiltIn.Components.Ground
{
    ...
    /// Scenery description
    /// </summary>
    public class SceneryDescription : GroundDescription
    {
        /// <summary>
        ...
        public static SceneryDescription FromHeightmap(NoiseMap heightmap, float cellSize, float maximumHeight, Curve heightCurve, HeightmapTexturesDescription textures, int quadtreeDepth = 3)
        {
            return new()
            {
        ...
        /// <param name="quadtreeDepth">Quadtree depth</param>
        public static SceneryDescription FromHeightmapDescription(HeightmapDescription description, int quadtreeDepth = 3)
        {
            return new()
            {
                Quadtree = QuadtreeDescription.Default(quadtreeDepth),
        ...
        /// <param name="quadtreeDepth">Quadtree depth</param>
        public static SceneryDescription FromFile(string contentFolder, string fileName, int quadtreeDepth = 3)
        {
            return new()
            {
                Quadtree = QuadtreeDescription.Default(quadtreeDepth),
