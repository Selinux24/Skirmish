...
namespace Engine.BuiltIn
{
    ...
    public class BasicPositionNormalColorSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public BasicPositionNormalColorSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(BasicPositionNormalColorSkinnedVsI), "main", ShaderDefaultBasicResources.PositionNormalColorSkinnedI_vs, HelperShaders.VSProfile);
