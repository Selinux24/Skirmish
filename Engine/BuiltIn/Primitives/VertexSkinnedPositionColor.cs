    ...
    public struct VertexSkinnedPositionColor : IVertexData
    {
        ...
        public static EngineInputElement[] Input(int slot)
        {
            ...
            [
                ...
                new ("COLOR", 0, SharpDX.DXGI.Format.R32G32B32A32_Float, 12, slot, EngineInputClassification.PerVertexData, 0),
                new ("WEIGHTS", 0, SharpDX.DXGI.Format.R32G32B32_Float, 28, slot, EngineInputClassification.PerVertexData, 0),
                new ("BONEINDICES", 0, SharpDX.DXGI.Format.R8G8B8A8_UInt, 40, slot, EngineInputClassification.PerVertexData, 0 ),
            ];
        }
        /// <summary>
        ...
        public static async Task<IEnumerable<VertexSkinnedPositionColor>> Convert(IEnumerable<VertexData> vertices, IEnumerable<Weight> weights, IEnumerable<string> skinBoneNames)
        {
            var vArray = vertices.ToArray();
            var vWeights = weights.ToArray();
            var vBones = skinBoneNames.ToArray();

            var res = new VertexSkinnedPositionColor[vArray.Length];
