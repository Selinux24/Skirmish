...
namespace Engine.BuiltIn.Deferred
{
    ...
    public class DeferredLightDirectionalPs : IBuiltInShader<EnginePixelShader>
    {
        ...
        public DeferredLightDirectionalPs(Graphics graphics)
        {
            Graphics = graphics;

            Shader = graphics.CompilePixelShader(nameof(DeferredLightDirectionalPs), "main", DeferredRenderingResources.DeferredLightDirectional_ps, HelperShaders.PSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
        ~DeferredLightDirectionalPs()
        {
        ...
        public void SetShaderResources(IEngineDeviceContext dc)
        {
            ...
            dc.SetPixelShaderResourceView(deferredBuffer.Count(), BuiltInShaders.GetShadowMapDirResourceView());
