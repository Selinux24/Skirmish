...
namespace Engine.BuiltIn.Deferred
{
    ...
    /// </summary>
    public class DeferredLightPointPs : IBuiltInShader<EnginePixelShader>
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public DeferredLightPointPs()
        {
            Shader = BuiltInShaders.CompilePixelShader<DeferredLightPointPs>("main", DeferredRenderingResources.DeferredLightPoint_ps);
        }
        ...
        public void SetShaderResources(IEngineDeviceContext dc)
        {
            ...
            dc.SetPixelShaderResourceView(deferredBuffer.Length, BuiltInShaders.GetShadowMapPointResourceView());
