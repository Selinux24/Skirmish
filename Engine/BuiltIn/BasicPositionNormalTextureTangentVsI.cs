...
namespace Engine.BuiltIn
{
    ...
    public class BasicPositionNormalTextureTangentVsI : IBuiltInVertexShader
    {
        ...
        public BasicPositionNormalTextureTangentVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(BasicPositionNormalTextureTangentVsI), "main", ShaderDefaultBasicResources.PositionNormalTextureTangentI_vs, HelperShaders.VSProfile);
