...
namespace Engine.BuiltIn
{
    ...
    public class ShadowSkinnedPositionTextureVsI : IBuiltInVertexShader
    {
        ...
        public ShadowSkinnedPositionTextureVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(ShadowSkinnedPositionTextureVsI), "main", ShaderShadowBasicResources.PositionTextureSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
