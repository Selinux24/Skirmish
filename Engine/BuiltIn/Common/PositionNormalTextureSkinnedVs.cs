...
namespace Engine.BuiltIn.Common
{
    ...
    public class PositionNormalTextureSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureSkinnedVs), "main", ForwardRenderingResources.PositionNormalTextureSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
