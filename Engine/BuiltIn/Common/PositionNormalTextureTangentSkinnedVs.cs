...
namespace Engine.BuiltIn.Common
{
    ...
    /// </summary>
    public class PositionNormalTextureTangentSkinnedVs : IBuiltInShader<EngineVertexShader>
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public PositionNormalTextureTangentSkinnedVs()
        {
            Shader = BuiltInShaders.CompileVertexShader<PositionNormalTextureTangentSkinnedVs>("main", CommonResources.PositionNormalTextureTangentSkinned_vs);
        }
