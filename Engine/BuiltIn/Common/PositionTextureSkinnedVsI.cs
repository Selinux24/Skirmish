...
namespace Engine.BuiltIn.Common
{
    ...
    public class PositionTextureSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public PositionTextureSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionTextureSkinnedVsI), "main", ForwardRenderingResources.PositionTextureSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
