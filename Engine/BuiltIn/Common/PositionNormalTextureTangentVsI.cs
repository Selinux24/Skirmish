...
namespace Engine.BuiltIn.Common
{
    ...
    public class PositionNormalTextureTangentVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentVsI), "main", ForwardRenderingResources.PositionNormalTextureTangentI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
