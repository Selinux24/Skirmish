...
namespace Engine.BuiltIn.Common
{
    ...
    /// </summary>
    public class PositionNormalTextureTangentVs : IBuiltInShader<EngineVertexShader>
    {
        /// <summary>
        ...
        public PositionNormalTextureTangentVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentVs), "main", CommonResources.PositionNormalTextureTangent_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
