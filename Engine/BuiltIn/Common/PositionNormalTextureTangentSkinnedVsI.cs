...
namespace Engine.BuiltIn.Common
{
    ...
    public class PositionNormalTextureTangentSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentSkinnedVsI), "main", ForwardRenderingResources.PositionNormalTextureTangentSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
