...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalTextureTangentVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentVsI), "main", ShaderShadowCascadeResources.PositionNormalTextureTangentI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
