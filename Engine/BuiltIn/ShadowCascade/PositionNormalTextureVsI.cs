...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalTextureVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureVsI), "main", ShaderShadowCascadeResources.PositionNormalTextureI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
