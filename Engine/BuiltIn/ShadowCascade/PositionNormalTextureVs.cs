...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalTextureVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader($"{nameof(ShadowCascade)}_{nameof(PositionNormalTextureVs)}", "main", ShaderShadowCascadeResources.PositionNormalTexture_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
