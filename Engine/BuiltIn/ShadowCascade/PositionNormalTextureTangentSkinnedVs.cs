...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalTextureTangentSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentSkinnedVs), "main", ShaderShadowCascadeResources.PositionNormalTextureTangentSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
