...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalColorVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalColorVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader($"{nameof(ShadowCascade)}_{nameof(PositionNormalColorVs)}", "main", ShaderShadowCascadeResources.PositionNormalColor_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
