...
namespace Engine.BuiltIn.ShadowCascade
{
    ...
    public class PositionNormalTextureTangentVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader($"{nameof(ShadowCascade)}_{nameof(PositionNormalTextureTangentVs)}", "main", ShaderShadowCascadeResources.PositionNormalTextureTangent_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
