    ...
    public struct VertexSkinnedPositionNormalTexture : IVertexData
    {
        ...
        public static EngineInputElement[] Input(int slot)
        {
            ...
            [
                ...
                new ("WEIGHTS", 0, SharpDX.DXGI.Format.R32G32B32_Float, 32, slot, EngineInputClassification.PerVertexData, 0),
                new ("BONEINDICES", 0, SharpDX.DXGI.Format.R8G8B8A8_UInt, 44, slot, EngineInputClassification.PerVertexData, 0 ),
            ];
        }
        /// <summary>
        ...
        public static async Task<IEnumerable<VertexSkinnedPositionNormalTexture>> Convert(IEnumerable<VertexData> vertices, IEnumerable<Weight> weights, IEnumerable<string> skinBoneNames)
        {
            var vArray = vertices.ToArray();
            var vWeights = weights.ToArray();
            var vBones = skinBoneNames.ToArray();

            var res = new VertexSkinnedPositionNormalTexture[vArray.Length];
