    ...
    public struct VertexSkinnedPositionNormalColor : IVertexData
    {
        ...
        public static EngineInputElement[] Input(int slot)
        {
            ...
            [
                ...
                new ("WEIGHTS", 0, SharpDX.DXGI.Format.R32G32B32_Float, 40, slot, EngineInputClassification.PerVertexData, 0),
                new ("BONEINDICES", 0, SharpDX.DXGI.Format.R8G8B8A8_UInt, 52, slot, EngineInputClassification.PerVertexData, 0 ),
            ];
        }
        /// <summary>
        ...
        public static async Task<IEnumerable<VertexSkinnedPositionNormalColor>> Convert(IEnumerable<VertexData> vertices, IEnumerable<Weight> weights, IEnumerable<string> skinBoneNames)
        {
            var vArray = vertices.ToArray();
            var vWeights = weights.ToArray();
            var vBones = skinBoneNames.ToArray();

            var res = new VertexSkinnedPositionNormalColor[vArray.Length];
