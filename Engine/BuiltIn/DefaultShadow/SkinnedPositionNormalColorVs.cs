...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    /// </summary>
    public class SkinnedPositionNormalColorVs : IBuiltInVertexShader
    {
        /// <summary>
        ...
        public SkinnedPositionNormalColorVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(SkinnedPositionNormalColorVs), "main", ShaderShadowBasicResources.PositionNormalColorSkinned_vs, HelperShaders.VSProfile);

            cbPerInstance = new EngineConstantBuffer<PerInstance>(graphics, nameof(SkinnedPositionNormalColorVs) + "." + nameof(PerInstance));
        }
        /// <summary>
        /// Destructor
        /// </summary>
