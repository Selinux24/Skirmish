...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    public class ShadowSkinnedPositionNormalTextureTangentVs : IBuiltInVertexShader
    {
        ...
        public ShadowSkinnedPositionNormalTextureTangentVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(ShadowSkinnedPositionNormalTextureTangentVs), "main", ShaderShadowBasicResources.PositionNormalTextureTangentSkinned_vs, HelperShaders.VSProfile);
