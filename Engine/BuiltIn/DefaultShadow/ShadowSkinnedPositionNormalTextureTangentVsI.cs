...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    public class ShadowSkinnedPositionNormalTextureTangentVsI : IBuiltInVertexShader
    {
        ...
        public ShadowSkinnedPositionNormalTextureTangentVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(ShadowSkinnedPositionNormalTextureTangentVsI), "main", ShaderShadowBasicResources.PositionNormalTextureTangentSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
