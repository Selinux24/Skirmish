...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    public class SkinnedPositionNormalTextureVs : IBuiltInVertexShader
    {
        ...
        public SkinnedPositionNormalTextureVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(SkinnedPositionNormalTextureVs), "main", ShaderShadowBasicResources.PositionNormalTextureSkinned_vs, HelperShaders.VSProfile);
