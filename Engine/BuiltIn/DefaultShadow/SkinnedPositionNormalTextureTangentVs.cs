...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    public class SkinnedPositionNormalTextureTangentVs : IBuiltInVertexShader
    {
        ...
        public SkinnedPositionNormalTextureTangentVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(SkinnedPositionNormalTextureTangentVs), "main", ShaderShadowBasicResources.PositionNormalTextureTangentSkinned_vs, HelperShaders.VSProfile);
