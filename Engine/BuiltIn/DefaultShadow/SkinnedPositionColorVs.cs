...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    /// </summary>
    public class SkinnedPositionColorVs : IBuiltInVertexShader
    {
        /// <summary>
        ...
        public SkinnedPositionColorVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(SkinnedPositionColorVs), "main", ShaderShadowBasicResources.PositionColorSkinned_vs, HelperShaders.VSProfile);
