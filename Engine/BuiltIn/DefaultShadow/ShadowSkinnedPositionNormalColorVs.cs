...
namespace Engine.BuiltIn.DefaultShadow
{
    ...
    public class ShadowSkinnedPositionNormalColorVs : IBuiltInVertexShader
    {
        ...
        public ShadowSkinnedPositionNormalColorVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(ShadowSkinnedPositionNormalColorVs), "main", ShaderShadowBasicResources.PositionNormalColorSkinned_vs, HelperShaders.VSProfile);
