...
namespace Engine.BuiltIn.Drawers.Common
{
    ...
    /// </summary>
    public class PositionColorSkinnedVs : IBuiltInShader<EngineVertexShader>
    {
        /// <summary>
        ...
        /// Constructor
        /// </summary>
        public PositionColorSkinnedVs()
        {
            Shader = BuiltInShaders.CompileVertexShader<PositionColorSkinnedVs>("main", CommonResources.PositionColorSkinned_vs);
        }
