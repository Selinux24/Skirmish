...
namespace Engine.BuiltIn.Default
{
    ...
    public class BasicPositionNormalColorVsI : IBuiltInVertexShader
    {
        ...
        public BasicPositionNormalColorVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(BasicPositionNormalColorVsI), "main", ShaderDefaultBasicResources.PositionNormalColorI_vs, HelperShaders.VSProfile);
