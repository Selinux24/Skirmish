...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureVsI), "main", ShaderDefaultBasicResources.PositionNormalTextureI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
