...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureTangentSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentSkinnedVs), "main", ShaderDefaultBasicResources.PositionNormalTextureTangentSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
