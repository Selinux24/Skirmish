...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureTangentSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentSkinnedVs), "main", ForwardRenderingResources.PositionNormalTextureTangentSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
