...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureSkinnedVsI), "main", ForwardRenderingResources.PositionNormalTextureSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
