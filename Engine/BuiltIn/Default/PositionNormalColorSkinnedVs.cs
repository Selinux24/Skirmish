...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalColorSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalColorSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalColorSkinnedVs), "main", ForwardRenderingResources.PositionNormalColorSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
