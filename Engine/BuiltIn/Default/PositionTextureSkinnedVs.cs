...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionTextureSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionTextureSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionTextureSkinnedVs), "main", ShaderDefaultBasicResources.PositionTextureSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
