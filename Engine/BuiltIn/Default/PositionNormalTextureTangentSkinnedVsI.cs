...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureTangentSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureTangentSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureTangentSkinnedVsI), "main", ShaderDefaultBasicResources.PositionNormalTextureTangentSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
