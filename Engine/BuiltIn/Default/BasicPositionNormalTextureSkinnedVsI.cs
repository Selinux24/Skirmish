...
namespace Engine.BuiltIn.Default
{
    ...
    public class BasicPositionNormalTextureSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public BasicPositionNormalTextureSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(BasicPositionNormalTextureSkinnedVsI), "main", ShaderDefaultBasicResources.PositionNormalTextureSkinnedI_vs, HelperShaders.VSProfile);
