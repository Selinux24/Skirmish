...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalColorSkinnedVsI : IBuiltInVertexShader
    {
        ...
        public PositionNormalColorSkinnedVsI(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalColorSkinnedVsI), "main", ForwardRenderingResources.PositionNormalColorSkinnedI_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
