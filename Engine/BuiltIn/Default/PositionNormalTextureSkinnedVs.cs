...
namespace Engine.BuiltIn.Default
{
    ...
    public class PositionNormalTextureSkinnedVs : IBuiltInVertexShader
    {
        ...
        public PositionNormalTextureSkinnedVs(Graphics graphics)
        {
            ...
            Shader = graphics.CompileVertexShader(nameof(PositionNormalTextureSkinnedVs), "main", ShaderDefaultBasicResources.PositionNormalTextureSkinned_vs, HelperShaders.VSProfile);
        }
        /// <summary>
        /// Destructor
        /// </summary>
