...
namespace Engine
{
    ...
    public class Terrain2 : Ground
    {
        ...
        public Terrain2(Game game, TerrainDescription desription)
            : base(game)
        {
            ...
            {
                this.graph = PathFinder.Build(this.Description.PathFinder.Settings, vertices, indices);
            }
