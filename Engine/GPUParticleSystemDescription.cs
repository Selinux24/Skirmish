...
namespace Engine
{
    ...
    /// </summary>
    public class GPUParticleSystemDescription : DrawableDescription
    {
        /// <summary>
        /// Emitters
        /// </summary>
        private List<GPUParticleEmitterDescription> emitters = new List<GPUParticleEmitterDescription>();

        /// <summary>
        /// Gets the particle emitters collection
        /// </summary>
        public GPUParticleEmitterDescription[] Emitters
        {
            get
            {
        ...
        /// Constructor
        /// </summary>
        public GPUParticleSystemDescription()
            : base()
        {
        ...
        {
            var emitter = GPUParticleEmitterDescription.GenerateFire(position, contentPath, textures);
    ...
    /// </summary>
    public class GPUParticleEmitterDescription
    {
        public static GPUParticleEmitterDescription GenerateFire(Vector3 position, string contentPath, params string[] textures)
        {
            return new GPUParticleEmitterDescription()
            {
                EmissionRate = 0.2f,
                EnergyMin = 2f,
                EnergyMax = 2.5f,
