...
namespace Engine
{
    ...
    public sealed class Curve3DKey(float position, Vector3 value, Vector3 tangentIn, Vector3 tangentOut, CurveContinuity continuity) : IEquatable<Curve3DKey>, IComparable<Curve3DKey>
    {
        /// <summary>
        ...
        /// </summary>
        public Vector3 TangentIn { get; set; } = tangentIn;
        /// <summary>
        /// Gets or sets a tangent when leaving this point to the next point on the curve.
        /// </summary>
        public Vector3 TangentOut { get; set; } = tangentOut;
        /// <summary>
        /// Gets a value of this point.
        /// </summary>
        public Vector3 Value { get; set; } = value;
