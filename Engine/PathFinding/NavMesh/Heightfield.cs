...
namespace Engine.PathFinding.NavMesh
{
    ...
    class HeightField
    {
        ...
        public HeightField(BoundingBox bbox, float cellSize, float cellHeight)
        {
            ...
            {
                this.cells[i] = new HeightFieldCell();
            }
        }
        ...
        private void RasterizeTriangles(Triangle[] tris, Area area)
        {
        ...
        /// <param name="area">The area flags for all of the triangles.</param>
        private void RasterizeTriangles(Triangle[] tris, int triOffset, int triCount, Area area)
        {
        ...
        private void RasterizeTriangle(ref Vector3 a, ref Vector3 b, ref Vector3 c, Area area)
        {
            ...
            for (int z = z0; z <= z1; z++)
            {
                ...
                for (int x = x0; x <= x1; x++)
                {
                    ...
                    //add the span
                    this.cells[z * this.Width + x].AddSpan(new HeightFieldSpan(spanMin, spanMax, area), this.Height);
                }
            }
        }
        /// <summary>
