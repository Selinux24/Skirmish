...
namespace Engine.PhysicsTests
{
    ...
    public class ContactDetectorHalfSpaceAndCylinderTests
    {
        ...
        {
            var cylinder = new CylinderCollider(radius, height);
                ...
                [
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = Vector3.Zero, Normal = Vector3.Up, Penetration = 0 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = Vector3.Down, Normal = Vector3.Up, Penetration = 1 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -2, 0), Normal = Vector3.Up, Penetration = 2 },
                                new (){ Point = new Vector3(0, 0, 0), Normal = Vector3.Up, Penetration = 0 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -3, 0), Normal = Vector3.Up, Penetration = 3 },
                                new (){ Point = new Vector3(0, -1, 0), Normal = Vector3.Up, Penetration = 1 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -6, 0), Normal = Vector3.Up, Penetration = 6 },
                                new (){ Point = new Vector3(0, -4, 0), Normal = Vector3.Up, Penetration = 4 },
                            ]
                        }
                    ],
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, 0, -1), Normal = Vector3.Up, Penetration = 0f },
                                new (){ Point = new Vector3(0, 0, 1), Normal = Vector3.Up, Penetration = 0f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -1, -1), Normal = Vector3.Up, Penetration = 1f },
                                new (){ Point = new Vector3(0, -1, 1), Normal = Vector3.Up, Penetration = 1f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -2, -1), Normal = Vector3.Up, Penetration = 2f },
                                new (){ Point = new Vector3(0, 0, -1), Normal = Vector3.Up, Penetration = 0f },
                                new (){ Point = new Vector3(0, -2, 1), Normal = Vector3.Up, Penetration = 2f },
                                new (){ Point = new Vector3(0, 0, 1), Normal = Vector3.Up, Penetration = 0f },
                            ]
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -3, -1), Normal = Vector3.Up, Penetration = 3f },
                                new (){ Point = new Vector3(0, -1, -1), Normal = Vector3.Up, Penetration = 1f },
                                new (){ Point = new Vector3(0, -3, 1), Normal = Vector3.Up, Penetration = 3f },
                                new (){ Point = new Vector3(0, -1, 1), Normal = Vector3.Up, Penetration = 1f },
                            ]
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -6, -1), Normal = Vector3.Up, Penetration = 6f },
                                new (){ Point = new Vector3(0, -4, -1), Normal = Vector3.Up, Penetration = 4f },
                                new (){ Point = new Vector3(0, -6, 1), Normal = Vector3.Up, Penetration = 6f },
                                new (){ Point = new Vector3(0, -4, 1), Normal = Vector3.Up, Penetration = 4f },
                            ]
                        }
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, 0, 0), Normal = Vector3.Up, Penetration = 0f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -1, 0), Normal = Vector3.Up, Penetration = 1f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            [
                                new (){ Point = new Vector3(0, 0, 0), Normal = Vector3.Up, Penetration = 0f },
                                new (){ Point = new Vector3(0, -2, 0), Normal = Vector3.Up, Penetration = 2f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            [
                                new (){ Point = new Vector3(0, -1, 0), Normal = Vector3.Up, Penetration = 1f },
                                new (){ Point = new Vector3(0, -3, 0), Normal = Vector3.Up, Penetration = 3f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -4, 0), Normal = Vector3.Up, Penetration = 4f },
                                new (){ Point = new Vector3(0, -6, 0), Normal = Vector3.Up, Penetration = 6f },
                            ]
                        }
                    ],
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -(1 + PiOverFourDisplacement), 0), Normal = Vector3.Up, Penetration = 1 + PiOverFourDisplacement },
                                new (){ Point = new Vector3(0, 0, -(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 0f },
                                new (){ Point = new Vector3(0, 0, 1 + PiOverFourDisplacement), Normal = Vector3.Up, Penetration = 0f },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -(1 + PiOverFourDisplacement) * 2f, 0), Normal = Vector3.Up, Penetration = (1 + PiOverFourDisplacement) * 2f },
                                new (){ Point = new Vector3(0, -(1 + PiOverFourDisplacement), -(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 1 + PiOverFourDisplacement },
                                new (){ Point = new Vector3(0, -(1 + PiOverFourDisplacement), +(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 1 + PiOverFourDisplacement },
                                new (){ Point = new Vector3(0, 0, 0), Normal = Vector3.Up, Penetration = 0 },
                            ]
                        }
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -(3 + PiOverFourDisplacement), 0), Normal = Vector3.Up, Penetration = 3 + PiOverFourDisplacement },
                                new (){ Point = new Vector3(0, -2f, -(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 2f },
                                new (){ Point = new Vector3(0, -2f, +(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 2f },
                                new (){ Point = new Vector3(0, -(1 - PiOverFourDisplacement), 0), Normal = Vector3.Up, Penetration = 1 - PiOverFourDisplacement },
                            ]
                        }
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -(6 + PiOverFourDisplacement), 0), Normal = Vector3.Up, Penetration = 6 + PiOverFourDisplacement },
                                new (){ Point = new Vector3(0, -5f, -(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 5f },
                                new (){ Point = new Vector3(0, -5f, +(1 + PiOverFourDisplacement)), Normal = Vector3.Up, Penetration = 5f },
                                new (){ Point = new Vector3(0, -(4 - PiOverFourDisplacement), 0), Normal = Vector3.Up, Penetration = 4 - PiOverFourDisplacement },
                            ]
                        }
                    ],
                    ...
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, 0, 0), Normal = PiOverFourPlaneNormal, Penetration = 0 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -PiOverFourNormal, -PiOverFourNormal), Normal = PiOverFourPlaneNormal, Penetration = 1 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -PiOverFourNormal * 2, -PiOverFourNormal * 2), Normal = PiOverFourPlaneNormal, Penetration = 2 },
                                new (){ Point = new Vector3(0, 0, 0), Normal = PiOverFourPlaneNormal, Penetration = 0 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -PiOverFourNormal * 3, -PiOverFourNormal * 3), Normal = PiOverFourPlaneNormal, Penetration = 3 },
                                new (){ Point = new Vector3(0, -PiOverFourNormal, -PiOverFourNormal), Normal = PiOverFourPlaneNormal, Penetration = 1 },
                            ]
                        }
                    ],
                    [
                        new HalfSpaceAndCylinderData
                        {
                            ...
                            Contacts =
                            [
                                new (){ Point = new Vector3(0, -PiOverFourNormal * 6, -PiOverFourNormal * 6), Normal = PiOverFourPlaneNormal, Penetration = 6 },
                                new (){ Point = new Vector3(0, -PiOverFourNormal * 4, -PiOverFourNormal * 4), Normal = PiOverFourPlaneNormal, Penetration = 4 },
                            ]
                        }
                    ],
                ];
