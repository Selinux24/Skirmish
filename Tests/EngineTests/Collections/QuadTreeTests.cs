...
namespace EngineTests.Collections
{
    ...
    public class QuadTreeTests
    {
        ...
        public void TestConstructor()
        {
            ...
            CollectionAssert.AreEqual(Array.Empty<QuadTreeNode>(), children[0].Children);
            CollectionAssert.AreEqual(Array.Empty<QuadTreeNode>(), children[1].Children);
            CollectionAssert.AreEqual(Array.Empty<QuadTreeNode>(), children[2].Children);
            CollectionAssert.AreEqual(Array.Empty<QuadTreeNode>(), children[3].Children);
        }
        ...
        public void TestParent()
        {
            ...
            var children0 = children[0].Children;
            ...
            var children1 = children[1].Children;
            ...
            var children2 = children[2].Children;
            ...
            var children3 = children[3].Children;
        ...
        public void TestLeafNodes()
        {
            ...
            QuadTreeNode[] lNodes =
            [
                .. q.Root.Children[0].Children,
                .. q.Root.Children[1].Children,
                .. q.Root.Children[2].Children,
                .. q.Root.Children[3].Children
            ];
