...
namespace Engine.PathFinding.AStar
{
    ...
    public struct GridFile
    {
        ...
        public static async Task<GridFile> FromGrid(Grid grid)
        {
            var tris = await grid.Input.GetTriangles();
        ...
        public static async Task<Grid> FromGraphFile(GridFile file, GridInput input)
        {
        ...
        /// <returns>Returns the graph file</returns>
        public static async Task<GridFile> Load(string fileName)
        {
            try
            {
        ...
        public static async Task Save(string fileName, Grid graph)
        {
            try
            {
                var graphFile = await FromGrid(graph);
