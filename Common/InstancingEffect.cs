...
namespace Common
{
    ...
    public class InstancingEffect : EffectBase
    {
        private EffectMatrixVariable worldTranspose = null;
        private EffectMatrixVariable worldInverseTranspose = null;
        ...
        public Matrix WorldTranspose
        {
            get
            {
                return this.worldTranspose.GetMatrix();
            }
            set
            {
                this.worldTranspose.SetMatrix(value);
            }
        }
        public Matrix WorldInverseTranspose
        {
            get
            {
                return this.worldInverseTranspose.GetMatrix();
            }
            set
            {
                this.worldInverseTranspose.SetMatrix(value);
            }
        }
        ...
        public InstancingEffect(Device device, VertexTypes vertexType)
            : base(vertexType)
        {
            ...
            this.worldTranspose = this.Effect.GetVariableByName("gWorld").AsMatrix();
            this.worldInverseTranspose = this.Effect.GetVariableByName("gWorldInverse").AsMatrix();
        ...
        {
            this.WorldTranspose = mBuffer.World;
            this.WorldInverseTranspose = mBuffer.WorldInverse;
